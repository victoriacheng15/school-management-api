...
class TestCourseCreateService:
    def test_create_new_courses(
        ...
        for row in valid_course_rows:
            if isinstance(row, tuple):
                ...
                keys = ["id", "title", "code", "term_id", "department_id", "created_at", "updated_at", "is_archived"]
    ...
    def test_create_new_courses_failure(
        self, mock_course_dict_to_row, mock_db_instance, mock_db_create, mock_db_read_many, valid_course_create_data
    ):
        # Mock the course_dict_to_row function
        mock_course_dict_to_row.return_value = ("title", "code", 1, 1)
...
class TestCourseUpdateService:
    ...
    def test_update_courses_no_success(
        self, mock_course_dict_to_row, mock_db_instance, mock_db_update, mock_db_read_many, mock_db_read_one, valid_course_update_data, valid_course_row
    ):
        # Mock the course_dict_to_row function
        mock_course_dict_to_row.return_value = ("title", "code", 1, 1)
    ...
    def test_update_courses_missing_id(
        self, mock_course_dict_to_row, mock_db_instance, mock_db_update, mock_db_read_many, mock_db_read_one, course_missing_id
    ):
...
class TestCourseArchiveService:
    def test_archive_courses(self, mock_db_instance, mock_db_archive, mock_db_read_one, mock_db_read_many, valid_course_ids, valid_course_row):
        # Mock that courses exist
        mock_db_read_one.return_value = valid_course_row  # Mock get_existing_func
        mock_db_read_many.return_value = [valid_course_row, valid_course_row]  # Mock read_by_ids_func
    ...
    def test_archive_courses_none_archived(self, mock_db_instance, mock_db_archive, mock_db_read_one, mock_db_read_many, valid_course_ids, valid_course_row):
        # Mock that courses exist
        mock_db_read_one.return_value = valid_course_row  # Mock get_existing_func
    ...
    def test_archive_courses_invalid_ids(self, mock_db_instance, mock_db_archive, mock_db_read_one, mock_db_read_many):
