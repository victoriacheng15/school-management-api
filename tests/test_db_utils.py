...
from db.db_utils import get_db_type, is_postgresql, get_boolean_true, get_boolean_false, get_insert_returning_query, get_archived_condition
...
def test_db_utils():
    ...
    print(f"  Insert query: {get_insert_returning_query('test_table', ['col1', 'col2'])}")
