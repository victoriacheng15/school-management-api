...
from app.models.student import student_db_read_all, student_db_insert, student_db_read_by_id, student_db_update, student_db_archive
...
def test_student_model_postgresql():
    ...
    try:
        ...
        student_data = (
            ...
            'Toronto', 'ON', 'Canada', 'local', 'active', 
            False, False, 1  # program_id = 1
        )
        ...
        if new_id:
            ...
            updated_data = (
                'John', 'Smith', 'john.smith@example.com', '456 Oak St',
                'Vancouver', 'BC', 'Canada', 'local', 'active',
                True, False, 1
            )
